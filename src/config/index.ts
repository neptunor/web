...
export { BRAND_LOGO_URL, BRAND_FAVICON_ICO, BRAND_OG_IMAGE, BRAND_HERO_IMAGE, BRAND_HERO_IMAGE_768, BRAND_HERO_IMAGE_480, BRAND_HERO_IMAGE_WEBP, BRAND_ASSETS_CDN, BRAND_SOCIAL, BRAND_CONTACT, BRAND_BOILERPLATE, BRAND_BUILD_LINE, BRAND_NOT_ROB, BRAND_COMPANY_NAME, BRAND_PARENT_BRAND } from './branding'
