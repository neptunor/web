...
export function SiteNav() {
  ...
  const navItems: NavItem[] = useMemo(() => [
      ...
      groups: [
        {
          ...
          items: [
            { label: t('sup.nav.productsServicesDropdown.startProject'), href: '/start-boat-project', highlight: true },
        ...
        },
        {
          ...
          items: [
            ...
            { label: t('sup.nav.productsServicesDropdown.constructionComparison'), href: '/inflatable-boat-certification' },
            { label: t('sup.nav.productsServicesDropdown.privateLabel'), href: '/solutions/private-label-boats' },
    ...
    },
    {
      ...
      groups: [
        ...
        },
        {
          ...
          items: [
            { label: t('sup.nav.industriesDropdown.resorts'), href: '/solutions/fleet-rental' },
            { label: t('sup.nav.industriesDropdown.clubs'), href: '/solutions/custom-boats' },
            { label: t('sup.nav.industriesDropdown.rental'), href: '/solutions/fleet-rental' },
            { label: t('sup.nav.industriesDropdown.distributors'), href: '/solutions/yacht-tender-dealers' },
            { label: t('sup.nav.industriesDropdown.retail'), href: '/solutions/private-label-boats' },
          ],
        },
      ],
    },
      ...
      groups: [
        {
          ...
          items: [
            ...
            { label: t('sup.nav.proofQualityDropdown.complianceByMarket'), href: '/inflatable-boat-certification' },
    ...
    },
    {
      ...
      items: [
        { label: t('sup.nav.resourcesDropdown.buyerResourceCenter'), href: '/resources/rib-buyer-resource-center', highlight: true },
        { label: t('sup.nav.resourcesDropdown.complianceGuide'), href: '/resources/rib-compliance-documentation' },
        { label: t('sup.nav.resourcesDropdown.cadGuide'), href: '/resources/rib-ga-cad-planning' },
        { label: t('sup.nav.resourcesDropdown.cadAccessGuide'), href: '/resources/rib-cad-access-request' },
        { label: t('sup.nav.resourcesDropdown.rfqGuide'), href: '/resources/rib-rfq-qualification' },
        { label: t('sup.nav.resourcesDropdown.distributorGuide'), href: '/resources/rib-distributor-application' },
        { label: t('sup.nav.resourcesDropdown.packingGuide'), href: '/resources/rib-export-packing' },
        { label: t('sup.nav.resourcesDropdown.traceabilityGuide'), href: '/resources/rib-traceability-evidence' },
        { label: t('sup.nav.resourcesDropdown.materialGuide'), href: '/resources/rib-tube-material-testing' },
        { label: t('sup.nav.resourcesDropdown.winHinGuide'), href: '/resources/rib-win-hin-iso-10087' },
        { label: t('sup.nav.resourcesDropdown.micGuide'), href: '/resources/rib-manufacturer-identification-code' },
        { label: t('sup.nav.resourcesDropdown.afterSalesGuide'), href: '/resources/rib-after-sales-spares' },
        ...
        { label: t('sup.nav.resourcesDropdown.sizeGuide'), href: '/oem-boat-moq' },
  ...
  const cta = (
    <a href={fl('/start-boat-project')} className={buttonVariants({ size: 'sm' })}>
      {t('sup.nav.cta')}
    </a>
  )
