    ...
    <footer className="relative border-t border-border bg-bg-alt px-5 pb-12 pt-16 md:px-8 lg:px-10">
      ...
      <div className="mx-auto grid max-w-7xl gap-10 sm:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1fr_1fr_1fr]">
        ...
        <FooterCol title={t('sup.footer.colProducts')}>
          ...
          <a className="foot-link" href={fl('/inflatable-boat-certification')}>{t('sup.nav.productsServicesDropdown.constructionComparison')}</a>
        ...
        <FooterCol title={t('sup.footer.colManufacturing')}>
          ...
          <a className="foot-link" href={fl('/inflatable-boat-certification')}>{t('sup.nav.proofQualityDropdown.complianceByMarket')}</a>
        ...
        <FooterCol title={t('sup.footer.colSolutions')}>
          ...
          <a className="foot-link" href={fl('/oem-manufacturing')}>{t('sup.footer.marketsNorthAmerica')}</a>
          <a className="foot-link" href={fl('/oem-manufacturing')}>{t('sup.footer.marketsEurope')}</a>
        </FooterCol>
