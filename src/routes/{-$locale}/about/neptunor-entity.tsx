...
/**
 * Entity hub (/about/neptunor-entity) — the GEO-facing page that links
 ...
 * describe "what Neptunor is".
 */
export const Route = createFileRoute('/{-$locale}/about/neptunor-entity')({
