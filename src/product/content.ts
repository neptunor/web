...
export const productFilters: Localized<{ all: string; groups: ProductFilterGroup[] }> = {
  en: {
    ...
    groups: [
      ...
      { key: 'inflatable-accessories', label: 'Inflatable Accessories' },
    ],
  },
  es: {
    ...
    groups: [
      ...
      { key: 'inflatable-accessories', label: 'Accesorios para inflables' },
    ],
  },
}
  ...
  en: {
    ...
    items: [
      ...
      },
      {
        ...
        specs: '4.70 m LOA · 2.00 m beam · 0.50 m tube · 9+1 persons · 50 HP max',
      ...
      },
      {
        ...
        specs: '3.80 m LOA · 1.92 m beam · 0.46 m tube · 7 persons',
      ...
      {
        slug: 'seat-drop-stitch',
        series: 'inflatable-accessories',
        sku: 'NSE-01',
        name: 'Drop-Stitch Seat',
        tagline: 'Inflatable seat with adjustable backrest',
        desc: 'A universal inflatable drop-stitch seat with adjustable backrest. High-pressure rigidity, diamond-grid EVA traction and 4-point webbing fit most inflatable kayaks, SUPs and rafts — a high-margin aftermarket accessory.',
        uses: ['Kayaks', 'SUPs', 'Rafts'],
        for: ['Accessory brands', 'Rental fleets'],
        specs: '5–10 psi drop-stitch core · universal 4-point mounting · packs flat',
        artwork: 'Drop-stitch cushion · adjustable backrest · diamond-grid EVA top · stainless snap hooks',
  ...
  es: {
    ...
    items: [
      ...
      },
      {
        ...
        specs: '4,70 m eslora · 2,00 m manga · 0,50 m tubo · 9+1 personas · 50 CV máx.',
      ...
      },
      {
        ...
        specs: '3,80 m eslora · 1,92 m manga · 0,46 m tubo · 7 plazas',
      ...
      },
      {
        ...
        series: 'inflatable-accessories',
        sku: 'NSE-01',
        name: 'Asiento Drop-Stitch',
        tagline: 'Asiento inflable con respaldo regulable',
        desc: 'Un asiento inflable universal drop-stitch con respaldo regulable. Rigidez de alta presión, tracción EVA de rejilla diamante y correas de 4 puntos para la mayoría de kayaks, SUPs y balsas — un accesorio de alto margen.',
        uses: ['Kayaks', 'SUPs', 'Balsas'],
        for: ['Marcas de accesorios', 'Flotas de alquiler'],
        specs: 'Núcleo drop-stitch 5–10 psi · fijación universal de 4 puntos · se pliega plano',
        artwork: 'Cojín drop-stitch · respaldo regulable · superficie EVA · mosquetones de acero inoxidable',
        image: 'https://neptunor.com/assets/products/2026/inflatable-accessories/seat-drop-stitch-01.avif',
        hue: 220,
      },
    ],
...
export const boardCategories: Localized<BoardCategoriesContent> = {
  en: {
    ...
    items: [
      ...
      { id: 'inflatable-accessories', label: 'Inflatable Accessories', desc: 'Drop-stitch seats and add-ons for kayaks, SUPs and rafts.', image: 'https://neptunor.com/assets/products/2026/inflatable-accessories/seat-drop-stitch-01.avif', href: '/products/seat-drop-stitch' },
    ],
  },
  es: {
    ...
    items: [
      ...
      { id: 'inflatable-accessories', label: 'Accesorios para inflables', desc: 'Asientos drop-stitch y complementos para kayaks, SUPs y balsas.', image: 'https://neptunor.com/assets/products/2026/inflatable-accessories/seat-drop-stitch-01.avif', href: '/products/seat-drop-stitch' },
    ],
  },
}
