...
export const why: Localized<WhyContent> = {
  en: {
    ...
    image: 'https://assets.neptunor.com/site/images/boats/factory/neptunor-production-hall.webp',
...
export const trustBar: Localized<TrustBarContent> = {
  en: {
    stats: [
      ...
      { value: FACTS.sampleTime, label: 'sample boats after specification approval' },
      { value: FACTS.leadTime, label: 'batch production after confirmed PO and deposit' },
      { value: 'ISO 9001 · CE · BSCI', label: 'documentation available by model and project' },
    ],
  },
  es: {
    stats: [
      { value: `MOQ ${MOQ_SHORT.standardRun}`, label: 'para volumen; pilotos desde 20–50 botes' },
      { value: FACTS.sampleTime, label: 'muestras tras aprobar la especificación' },
      { value: FACTS.leadTime, label: 'producción en serie tras PO y depósito confirmados' },
      { value: 'ISO 9001 · CE · BSCI', label: 'documentación disponible según modelo y proyecto' },
    ],
  },
}
    ...
    items: [
      {
        ...
        buyerState: 'You have drawings, specifications or a reference boat',
      ...
      },
      {
        ...
        buyerState: 'You have a product idea or market requirement',
      ...
      },
      {
        ...
        buyerState: 'You need branded boats without new tooling',
      ...
      },
      {
        ...
        buyerState: 'You are planning repeat, fleet or commercial supply',
        ctaLabel: 'Plan Production Supply',
      },
    ],
  },
  es: {
    ...
    items: [
      {
        ...
        buyerState: 'Ya tienes planos, especificaciones o un bote de referencia',
        ctaLabel: 'Fabricar según tu especificación',
      },
      {
        ...
        buyerState: 'Tienes una idea de producto o un requisito de mercado',
        ctaLabel: 'Desarrollar un bote desde tu brief',
      },
      {
        ...
        buyerState: 'Necesitas botes de marca sin utillaje nuevo',
        ctaLabel: 'Lanzar sobre una plataforma probada',
      },
      {
        ...
        buyerState: 'Planificas suministro comercial, de flota o reposición',
        ctaLabel: 'Planificar el suministro de producción',
      }
    ],
  },
}
  ...
  en: {
    ...
    items: [
      ...
      },
      {
        ...
        body: 'GRP hulls are laminated in temperature-controlled bays with controlled gelcoat thickness and documented layup schedules, from 2.5 m tenders to 7.6 m offshore flagships.',
      },
      {
  ...
  es: {
    ...
    items: [
      ...
      },
      {
        ...
        body: 'Los cascos de PRFV se laminan en naves con temperatura controlada, con espesor de gelcoat controlado y esquemas de laminado documentados, desde auxiliares de 2,5 m hasta buques insignia offshore de 7,6 m.',
      },
      {
...
const allProducts: Localized<ProductsContent> = {
  en: {
    ...
    items: [
      ...
      },
      {
        ...
        sku: 'NRB-760',
        name: 'RIB 760',
        tagline: 'Offshore flagship',
        desc: 'Neptunor’s largest fiberglass platform — a 7.6 m GRP hull with a 7-chamber collar, 300 L fuel capacity and up to 250 HP for serious offshore, charter and crew-transfer duty.',
        uses: ['Offshore', 'Charter', 'Crew transfer'],
        for: ['Charter operators', 'Fleet buyers'],
        specs: '7.60 m LOA · 2.70 m beam · 0.52 m tube · 13 persons · 250 HP max',
        artwork: 'Fiberglass or SS targa · full pickup seating · hydraulic steering option',
      ...
      },
      {
        ...
        sku: 'NRB-700',
        name: 'RIB 700',
        tagline: 'Guest or crew platform',
        desc: 'A 7.1 m fiberglass RIB rated for 250 HP — deep cockpit, 7-chamber collar, built-in 180 L fuel and a targa with navigation lights. Room for guest seating or a professional crew layout.',
        uses: ['Guest excursions', 'Rental flagship', 'Crew'],
        for: ['Resorts', 'Charter operators'],
        specs: '7.10 m LOA · 2.86 m beam · 0.52 m tube · 12 persons · 250 HP max',
        artwork: 'Full-length seating · 180 L tank · SS stern ladder · hydraulic steering option',
      ...
      },
      {
        ...
        sku: 'NRB-680A',
        name: 'RIB 680A',
        tagline: 'Charter & fishing workhorse',
        desc: 'A 6.6 m fiberglass RIB built for active duty — 200 HP rating, 7-chamber collar, 150 L fuel, live well and console helm. As comfortable at a charter dock as on a fishing radius.',
        uses: ['Charter', 'Fishing', 'Tour boats'],
        for: ['Tour operators', 'Charter fleets'],
        specs: '6.60 m LOA · 2.52 m beam · 0.52 m tube · 10 persons · 200 HP max',
        artwork: 'Live well · 150 L tank · targa with nav lights · console helm',
      ...
      },
      {
        ...
        sku: 'NRB-680B',
        name: 'RIB 680B',
        tagline: 'Cruise & tow platform',
        desc: 'A 6.8 m fiberglass RIB that tows as well as it cruises — 200 HP rating, full aft seating, ski bar, 100 L fuel and stainless targa. A flexible mid-large platform for mixed guest and watersports duty.',
        uses: ['Watersports', 'Day cruising', 'Charter'],
        for: ['Resorts', 'Dealer ranges'],
        specs: '6.80 m LOA · 2.52 m beam · 0.52 m tube · 10 persons · 200 HP max',
        artwork: 'SS ski bar · full seating · console helm · targa with nav lights',
      ...
      },
      {
        ...
        sku: 'NRB-600',
        name: 'RIB 600',
        tagline: 'The versatile 6 m',
        desc: 'A 6 m fiberglass RIB with a 115 HP rating and 6-chamber collar — full seating, sun deck, arch roll bar and a long optional list for rental, tour and dealer duty.',
        uses: ['Charter', 'Rental', 'Family'],
        for: ['Rental operators', 'Charter fleets'],
        specs: '6.00 m LOA · 2.50 m beam · 0.52 m tube · 8 persons · 115 HP max',
        artwork: 'Sun deck · arch roll bar · console helm · SS ladder options',
      ...
      },
      {
        ...
        sku: 'NRB-580A',
        name: 'RIB 580A',
        tagline: 'Console all-rounder',
        desc: 'A 5.8 m fiberglass RIB with a proper console helm, 115 HP rating and 5-chamber collar. The layout that family cruisers, rental operators and dealer ranges all spec.',
        uses: ['Family', 'Rental', 'Dealer ranges'],
        for: ['Dealers', 'Rental operators'],
        specs: '5.80 m LOA · 2.38 m beam · 0.52 m tube · 8 persons · 115 HP max',
        artwork: 'Console helm · SS handles & ski bar · targa with nav lights',
      ...
      },
      {
        ...
        sku: 'NRB-580B',
        name: 'RIB 580B',
        tagline: 'Wide-collar soft rider',
        desc: 'A 5.8 m fiberglass model with a fatter 58 cm collar for an even softer ride — 115 HP rating, 90 L fuel and 5-chamber safety. A premium-feel step up within the 580 line.',
        uses: ['Day cruising', 'Family', 'Rental'],
        for: ['Dealers', 'Resorts'],
        specs: '5.80 m LOA · 2.38 m beam · 0.58 m tube · 8 persons · 115 HP max',
        artwork: '58 cm collar · console helm · sun deck cushion option',
      ...
      },
      {
        ...
        sku: 'NRB-580C',
        name: 'RIB 580C',
        tagline: 'Retail console spec',
        desc: 'A 5.8 m fiberglass RIB with windscreen console as standard — 115 HP, 58 cm collar, 90 L fuel and five chambers. The everyday-helm configuration for retail lines.',
        uses: ['Retail lines', 'Day cruising', 'Rental'],
        for: ['Dealer networks', 'Retail buyers'],
        specs: '5.80 m LOA · 2.38 m beam · 0.58 m tube · 8 persons · 115 HP max',
        artwork: 'Windscreen console · SS handles & ski bar · targa with nav lights',
      ...
      },
      {
        ...
        sku: 'NRB-550A',
        name: 'RIB 550A',
        tagline: 'Lightweight family benches',
        desc: 'A lightweight 5.5 m fiberglass RIB — 240 kg dry, 90 HP rating and open bench layout with a 60 L tank. Easy to tow while keeping real family space.',
        uses: ['Family', 'Tow friendly', 'Coastal'],
        for: ['Dealers', 'Private ranges'],
        specs: '5.50 m LOA · 2.30 m beam · 0.52 m tube · 7 persons · 90 HP max',
        artwork: '2 benches · 60 L tank · console & steering options',
      ...
      },
      {
        ...
        sku: 'NRB-550B',
        name: 'RIB 550B',
        tagline: 'Dressed-up 5.5 m',
        desc: 'A 5.5 m fiberglass RIB that adds a console, aft sun deck, bow and stern seating, arch roll bar and a 100 L tank — 90 HP and a 5-chamber collar. The dressed-up 550 for retail and rental lines.',
        uses: ['Day cruising', 'Rental', 'Retail'],
        for: ['Rental operators', 'Dealers'],
        specs: '5.50 m LOA · 2.30 m beam · 0.52 m tube · 7 persons · 90 HP max',
        artwork: 'Sun deck · arch roll bar · SS backrest & ladder options',
      ...
      },
      {
        ...
        sku: 'NRB-520A',
        name: 'RIB 520A',
        tagline: 'The light 5.2 m',
        desc: 'A slim, light 5.2 m fiberglass RIB — 200 kg dry, 85 HP rating and a clean two-seat bench layout with 60 L tank. A tow-and-go platform for dealers and private buyers.',
        uses: ['Family', 'Tow friendly', 'Coastal'],
        for: ['Dealers', 'Private buyers'],
        specs: '5.20 m LOA · 2.00 m beam · 0.52 m tube · 8 persons · 85 HP max',
        artwork: '2 seats · 60 L tank · console & steering options',
        hue: 186,
      },
      {
        slug: 'rib-520b',
        ...
        sku: 'NRB-520B',
        name: 'RIB 520B',
        tagline: 'Balanced family console',
        desc: 'A 5.2 m fiberglass RIB with center console, front and rear benches, 80 L fuel and an 85 HP rating — the balanced family spec most dealer lines open with.',
        uses: ['Family', 'Dealer lines', 'Day cruising'],
        for: ['Dealers', 'Charter startups'],
        specs: '5.20 m LOA · 2.28 m beam · 0.52 m tube · 8 persons · 85 HP max',
        artwork: 'Center console · full seating · targa with nav lights',
      ...
      },
      {
        ...
        sku: 'NRB-520C',
        name: 'RIB 520C',
        tagline: 'Sun-deck console spec',
        desc: 'A 5.2 m fiberglass RIB that adds a cushioned sun deck and stainless fittings to the console layout — 360 kg dry, 85 HP and 70 L fuel options.',
        uses: ['Day cruising', 'Watersports', 'Retail'],
        for: ['Dealers', 'Resorts'],
        specs: '5.20 m LOA · 2.28 m beam · 0.52 m tube · 8 persons · 85 HP max',
        artwork: 'Sun deck cushion · SS handles · console helm',
      ...
      },
      {
        ...
        sku: 'NRB-520E',
        name: 'RIB 520E',
        tagline: 'Sport 115 HP spec',
        desc: 'A 5.2 m fiberglass RIB rated to 115 HP — stainless arch, ski tow backrest, 80 L gauged tank and removable console. The energetic 520 for watersports and faster coastal runs.',
        uses: ['Watersports', 'Speed', 'Rental premium'],
        for: ['Lifestyle brands', 'Rental operators'],
        specs: '5.20 m LOA · 2.25 m beam · 0.50 m tube · 8 persons · 115 HP max',
        artwork: 'SS arch & ski loop · gauged tank · console helm · sun deck option',
      ...
      },
      {
        ...
        sku: 'NRB-520W',
        name: 'RIB 520W',
        tagline: 'Wide and light',
        desc: 'A wide 2.35 m beam fiberglass RIB at just 230 kg — 85 HP, two seats and a front bench in a stable, spacious cockpit. Maximum deck feel with easy tow weight.',
        uses: ['Family', 'Tow friendly', 'Stability'],
        for: ['Private buyers', 'Dealers'],
        specs: '5.20 m LOA · 2.35 m beam · 0.52 m tube · 8 persons · 85 HP max',
        artwork: '2.35 m beam · 2 seats · front bench · console options',
      ...
      },
      {
        ...
        sku: 'NRB-500',
        name: 'RIB 500',
        tagline: 'Balanced 5 m console',
        desc: 'A 5 m fiberglass RIB with console helm, bow and stern benches, 60 L fuel and a 60 HP rating — a balanced platform for dealers, resorts and first-time fleets.',
        uses: ['Family', 'Rental', 'Dealer lines'],
        for: ['Dealers', 'Resorts'],
        specs: '5.00 m LOA · 2.10 m beam · 0.52 m tube · 6 persons · 60 HP max',
        artwork: 'Console helm · full benches · targa with nav lights',
      ...
      },
      {
        ...
        sku: 'NRB-480A',
        name: 'RIB 480A',
        tagline: 'The light 4.8 m',
        desc: 'A slim 4.8 m fiberglass RIB at just 183 kg — 60 HP rating, two-seat layout and front bench. Light enough for single-axle towing with genuine RIB stability.',
        uses: ['Tow friendly', 'Family', 'Coastal'],
        for: ['Private buyers', 'Dealers'],
        specs: '4.80 m LOA · 2.00 m beam · 0.48 m tube · 6 persons · 60 HP max',
        artwork: '2 seats · front bench · 60 HP transom',
      ...
      },
      {
        ...
        sku: 'NRB-480B',
        name: 'RIB 480B',
        tagline: 'Console workhorse 4.8 m',
        desc: 'A 4.8 m fiberglass RIB with center console, bow and stern benches and a 60 L tank — 60 HP and five chambers. The practical rental-and-family layout.',
        uses: ['Family', 'Rental', 'Utility'],
        for: ['Rental operators', 'Dealers'],
        specs: '4.80 m LOA · 2.00 m beam · 0.48 m tube · 6 persons · 60 HP max',
        artwork: 'Center console · full benches · targa with nav lights',
      ...
      },
      {
        ...
        sku: 'NRB-480C',
        name: 'RIB 480C',
        tagline: 'Screened-console 4.8 m',
        desc: 'A 4.8 m fiberglass RIB with a windscreen console and 4-point switch standard — 60 HP, five chambers and full seating. A polished retail spec for day boating.',
        uses: ['Day boating', 'Retail', 'Family'],
        for: ['Dealer networks', 'Retail buyers'],
        specs: '4.80 m LOA · 2.00 m beam · 0.48 m tube · 6 persons · 60 HP max',
        artwork: 'Windscreen console · full seating · 60 L tank option',
      ...
      },
      {
        ...
        sku: 'NRB-480D',
        name: 'RIB 480D',
        tagline: 'Ladder & sun-deck 4.8 m',
        desc: 'A 4.8 m fiberglass RIB adding a stainless stern ladder and sun deck cushion to the console layout — 60 HP, five chambers and very complete standard kit.',
        uses: ['Swimmers', 'Day boating', 'Family'],
        for: ['Resorts', 'Dealers'],
        specs: '4.80 m LOA · 2.00 m beam · 0.48 m tube · 6 persons · 60 HP max',
        artwork: 'SS stern ladder · sun deck cushion · console helm',
      ...
      },
      {
        ...
        sku: 'NRB-480W',
        name: 'RIB 480W',
        tagline: 'Wide 4.8 m tour spec',
        desc: 'A wide-beam 4.8 m fiberglass RIB with a center console plus side seat — 60 HP, 60 L tank and five chambers in a roomy cockpit for day trips and tours.',
        uses: ['Tours', 'Day boating', 'Family'],
        for: ['Tour operators', 'Resorts'],
        specs: '4.80 m LOA · 2.35 m beam · 0.48 m tube · 6 persons · 60 HP max',
        artwork: 'Side-seat console · 60 L tank · targa with nav lights',
        hue: 194,
      },
      {
        slug: 'rib-430a',
        ...
        sku: 'NRB-430A',
        name: 'RIB 430A',
        tagline: 'Entry-level 4.3 m',
        desc: 'A light 4.3 m fiberglass RIB — 170 kg dry, 40 HP rating and a clean two-seat bench layout. The accessible start of the 430 console line.',
        uses: ['Entry RIB', 'Family', 'Tow friendly'],
        for: ['Startups', 'Private buyers'],
        specs: '4.30 m LOA · 2.00 m beam · 0.47 m tube · 6 persons · 40 HP max',
        artwork: '2 seats · front bench · console & steering options',
      ...
      },
      {
        ...
        sku: 'NRB-430B',
        name: 'RIB 430B',
        tagline: 'Lake-sport 4.3 m',
        desc: 'A 4.3 m fiberglass RIB with center console, stainless ski loops, fuel tank prep and a 4-chamber collar — 40 HP aimed at lake sport and compact touring.',
        uses: ['Watersports', 'Lake', 'Day boating'],
        for: ['Lifestyle brands', 'Resorts'],
        specs: '4.30 m LOA · 2.00 m beam · 0.47 m tube · 6 persons · 40 HP max',
        artwork: 'Console helm · SS ski loops · 50 L tank option',
      ...
      },
      {
        ...
        sku: 'NRB-430C',
        name: 'RIB 430C',
        tagline: 'Option-heavy 4.3 m',
        desc: 'A 4.3 m fiberglass RIB with windscreen console, arch roll bar, fuel tank and one of the longest option lists in the range — from teak to hydraulic steering.',
        uses: ['Day boating', 'Retail', 'Rental'],
        for: ['Dealers', 'Rental operators'],
        specs: '4.30 m LOA · 1.96 m beam · 0.48 m tube · 6 persons · 40 HP max',
        artwork: 'Arch roll bar · windscreen console · 50 L tank',
      ...
      },
      {
        ...
        sku: 'NRB-390A',
        name: 'RIB 390A',
        tagline: 'The light 3.9 m',
        desc: 'A 3.9 m fiberglass RIB at just 100 kg — 30 HP, two seats and 3-chamber collar. A tow-behind-any-car tender that still rides on a molded hull.',
        uses: ['Tender', 'Tow friendly', 'Entry'],
        for: ['Private buyers', 'Startups'],
        specs: '3.90 m LOA · 1.85 m beam · 0.47 m tube · 5 persons · 30 HP max',
        artwork: '2 seats · front bench · console & steering options',
      ...
      },
      {
        ...
        sku: 'NRB-390AL',
        name: 'RIB 390AL',
        tagline: 'Console 3.9 m',
        desc: 'A 3.9 m fiberglass RIB with a center console as standard — 30 HP, 4-chamber collar, cushioned front seating and a full option list including sun deck.',
        uses: ['Day boating', 'Family', 'Coastal'],
        for: ['Dealers', 'Resorts'],
        specs: '3.90 m LOA · 1.85 m beam · 0.42 m tube · 5 persons · 30 HP max',
        artwork: 'Console helm · 4 chambers · sun deck option',
      ...
      },
      {
        ...
        sku: 'NRB-390B',
        name: 'RIB 390B',
        tagline: 'Compact console 3.9 m',
        desc: 'A 3.9 m fiberglass RIB with center console, bow and stern benches and bilge pump — 30 HP, 3 chambers and 40 L tank options. The practical compact console.',
        uses: ['Day boating', 'Tours', 'Family'],
        for: ['Resorts', 'Dealers'],
        specs: '3.90 m LOA · 1.85 m beam · 0.47 m tube · 5 persons · 30 HP max',
        artwork: 'Console helm · full benches · 40 L tank option',
      ...
      },
      {
        ...
        sku: 'NRB-390BL',
        name: 'RIB 390BL',
        tagline: 'Best-equipped 3.9 m',
        desc: 'A 3.9 m fiberglass RIB with screened console, arch roll bar, sun deck, 25 L tank and the fullest standard-equipment list of the 390 line — 30 HP, 4 chambers.',
        uses: ['Day boating', 'Retail', 'Rental'],
        for: ['Dealer networks', 'Rental operators'],
        specs: '3.90 m LOA · 1.78 m beam · 0.42 m tube · 5 persons · 30 HP max',
        artwork: 'Screened console · arch roll bar · sun deck · 25 L tank',
      ...
      },
      {
        ...
        sku: 'NRB-360A',
        name: 'RIB 360A',
        tagline: 'Compact day boat',
        desc: 'A 3.6 m fiberglass RIB — 25 HP, three chambers and a 650 kg payload with two seats and a front bench. A compact day boat that tows easily.',
        uses: ['Day boating', 'Tender', 'Family'],
        for: ['Private buyers', 'Resorts'],
        specs: '3.60 m LOA · 1.80 m beam · 0.42 m tube · 5 persons · 25 HP max',
        artwork: '2 seats · front bench · console variants',
      ...
      },
      {
        ...
        sku: 'NRB-360B',
        name: 'RIB 360B',
        tagline: 'Side-seat compact',
        desc: 'A 3.6 m fiberglass RIB with a center console plus side seat, stainless fittings and bilge pump — 25 HP and a 100 kg dry weight. Urban- and lake-friendly.',
        uses: ['Day boating', 'Lake', 'Family'],
        for: ['Resorts', 'Private buyers'],
        specs: '3.60 m LOA · 1.80 m beam · 0.42 m tube · 5 persons · 25 HP max',
        artwork: 'Side-seat console · SS handles · bilge pump',
      ...
      },
      {
        ...
        sku: 'NRB-330A',
        name: 'RIB 330A',
        tagline: 'The 80 kg entry',
        desc: 'A 3.3 m fiberglass RIB at just 80 kg — 20 HP and a clean two-seat layout. The lightest real RIB in the range, easy to lift and tow.',
        uses: ['Entry', 'Tender', 'Tow friendly'],
        for: ['Private buyers', 'Startups'],
        specs: '3.30 m LOA · 1.60 m beam · 0.42 m tube · 4 persons · 20 HP max',
        artwork: 'Minimal layout · console & steering options',
      ...
      },
      {
        ...
        sku: 'NRB-330B',
        name: 'RIB 330B',
        tagline: 'Benched 3.3 m',
        desc: 'A 3.3 m fiberglass RIB with a front bench and anchor tray added to the two-seat base — 20 HP, three chambers and a 90 kg dry weight.',
        uses: ['Day boating', 'Tender', 'Family'],
        for: ['Resorts', 'Private buyers'],
        specs: '3.30 m LOA · 1.60 m beam · 0.42 m tube · 4 persons · 20 HP max',
        artwork: 'Front bench · anchor tray · console & steering options',
      ...
      },
      {
        ...
        sku: 'NRB-330C',
        name: 'RIB 330C',
        tagline: 'Finished small platform',
        desc: 'A 3.3 m fiberglass RIB with center console, bow and stern seating, teak floor option and 20 HP — the finished small-platform spec for retail.',
        uses: ['Day boating', 'Retail', 'Rental'],
        for: ['Dealers', 'Rental operators'],
        specs: '3.30 m LOA · 1.60 m beam · 0.42 m tube · 4 persons · 20 HP max',
        artwork: 'Console helm · full seating · teak option',
      ...
      },
      {
        ...
        sku: 'NRB-300',
        name: 'RIB 300',
        tagline: 'Compact 3 m tender',
        desc: 'A 3 m RIB weighing 90 kg with a 20 HP rating — four-person capacity, compact footprint and a long list of add-ons from wheels to seating.',
        uses: ['Tender', 'Beach', 'Entry'],
        for: ['Private buyers', 'Resorts'],
        specs: '3.00 m LOA · 1.60 m beam · 0.42 m tube · 4 persons · 20 HP max',
        artwork: 'Compact footprint · beach wheels option',
      ...
      },
      {
        ...
        sku: 'NRB-270',
        name: 'RIB 270',
        tagline: 'Light 2.7 m runabout',
        desc: 'A 2.7 m RIB at 64 kg with a 10 HP rating — three-person capacity in a light, hard-bottom tender that stows easily and launches anywhere.',
        uses: ['Tender', 'Beach', 'Backup'],
        for: ['Private buyers', 'Yachts'],
        specs: '2.70 m LOA · 1.62 m beam · 0.42 m tube · 3 persons · 10 HP max',
        artwork: '64 kg · 3 chambers · hard bottom',
      ...
      },
      {
        ...
        sku: 'NRB-250',
        name: 'RIB 250',
        tagline: 'Most portable tender',
        desc: 'A 2.5 m RIB at just 60 kg rated for 4.4 HP — three-person capacity, the smallest footprint in the range and the most portable fiberglass tender.',
        uses: ['Tender', 'Beach', 'Storage'],
        for: ['Private buyers', 'Yachts'],
        specs: '2.50 m LOA · 1.45 m beam · 0.38 m tube · 3 persons · 4 HP max',
        artwork: '60 kg · compact footprint · 3 chambers',
      ...
      },
      {
        ...
        specs: '3.30 m LOA · 1.55 m beam · 0.43 m tube · 4+1 persons · 15 HP max',
  ...
  es: {
    ...
    items: [
      ...
      },
      {
        ...
        sku: 'NRB-760',
        name: 'RIB 760',
        tagline: 'Insignia offshore',
        desc: 'La mayor plataforma de fibra de vidrio de Neptunor — casco PRFV de 7,6 m con collar de 7 cámaras, depósito de 300 L y hasta 250 CV para servicio offshore, chárter y traslado de tripulación.',
        uses: ['Alta mar', 'Chárter', 'Traslados'],
        for: ['Operadores de chárter', 'Compradores de flota'],
        specs: '7,60 m de eslora · manga 2,70 m · tubo de 0,52 m · 13 plazas · 250 CV máx.',
        artwork: 'Targa de fibra o acero inoxidable · asientos completos · dirección hidráulica opcional',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-760-01.avif',
        hue: 172,
      },
      {
        ...
        sku: 'NRB-700',
        name: 'RIB 700',
        tagline: 'Plataforma para invitados o tripulación',
        desc: 'Un RIB de fibra de vidrio de 7,1 m homologado para 250 CV — cockpit profundo, collar de 7 cámaras, depósito integrado de 180 L y targa con luces de navegación. Con espacio para asientos de invitados o una configuración de tripulación profesional.',
        uses: ['Excursiones de invitados', 'Alquiler insignia', 'Tripulación'],
        for: ['Resorts', 'Operadores de chárter'],
        specs: '7,10 m de eslora · manga 2,86 m · tubo de 0,52 m · 12 plazas · 250 CV máx.',
        artwork: 'Asientos a todo lo largo · depósito de 180 L · escalerilla de popa de acero inoxidable · dirección hidráulica opcional',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-700-01.avif',
        hue: 174,
      },
      {
        ...
        sku: 'NRB-680A',
        name: 'RIB 680A',
        tagline: 'Chárter y pesca',
        desc: 'Un RIB de fibra de vidrio de 6,6 m para servicio activo — 200 CV, collar de 7 cámaras, depósito de 150 L, pozo vivo y puesto de gobierno con consola. Tan cómodo en el muelle de un chárter como en un radio de pesca.',
        uses: ['Chárter', 'Pesca', 'Excursiones'],
        for: ['Operadores de excursiones', 'Flotas de chárter'],
        specs: '6,60 m de eslora · manga 2,52 m · tubo de 0,52 m · 10 plazas · 200 CV máx.',
        artwork: 'Pozo vivo · depósito de 150 L · targa con luces · consola de mando',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-680a-01.avif',
        hue: 176,
      },
      {
        ...
        sku: 'NRB-680B',
        name: 'RIB 680B',
        tagline: 'Navegación y remolque',
        desc: 'Un RIB de fibra de vidrio de 6,8 m que remolca igual de bien que navega — 200 CV, asientos de popa completos, barra de esquí, depósito de 100 L y targa de acero inoxidable. Una plataforma flexible para servicio mixto de invitados y deportes náuticos.',
        uses: ['Deportes náuticos', 'Crucero de día', 'Chárter'],
        for: ['Resorts', 'Gamas de distribuidor'],
        specs: '6,80 m de eslora · manga 2,52 m · tubo de 0,52 m · 10 plazas · 200 CV máx.',
        artwork: 'Barra de esquí de acero inoxidable · asientos completos · consola de mando · targa con luces',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-680b-01.avif',
        hue: 178,
      },
      {
        ...
        sku: 'NRB-600',
        name: 'RIB 600',
        tagline: 'El 6 m versátil',
        desc: 'Un RIB de fibra de vidrio de 6 m con 115 CV y collar de 6 cámaras — asientos completos, solárium, arco de protección y una larga lista de opciones para servicio de alquiler, excursiones y distribuidores.',
        uses: ['Chárter', 'Alquiler', 'Familiar'],
        for: ['Operadores de alquiler', 'Flotas de chárter'],
        specs: '6,00 m de eslora · manga 2,50 m · tubo de 0,52 m · 8 plazas · 115 CV máx.',
        artwork: 'Solárium · arco de protección · consola de mando · opciones de escalerilla de acero inoxidable',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-600-01.avif',
        hue: 180,
      },
      {
        ...
        sku: 'NRB-580A',
        name: 'RIB 580A',
        tagline: 'Polivalente a consola',
        desc: 'Un RIB de fibra de vidrio de 5,8 m con consola de mando completa, 115 CV y collar de 5 cámaras. La distribución que eligen cruceros familiares, operadores de alquiler y gamas de distribuidor.',
        uses: ['Familiar', 'Alquiler', 'Gamas de distribuidor'],
        for: ['Distribuidores', 'Operadores de alquiler'],
        specs: '5,80 m de eslora · manga 2,38 m · tubo de 0,52 m · 8 plazas · 115 CV máx.',
        artwork: 'Consola de mando · asas y barra de esquí de acero inoxidable · targa con luces',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-580a-01.avif',
        hue: 182,
      },
      {
        ...
        sku: 'NRB-580B',
        name: 'RIB 580B',
        tagline: 'Conducción suave de collar ancho',
        desc: 'Un modelo de fibra de vidrio de 5,8 m con collar de 58 cm más voluminoso para una navegación aún más suave — 115 CV, depósito de 90 L y seguridad de 5 cámaras. Un escalón con sensación premium dentro de la línea 580.',
        uses: ['Crucero de día', 'Familiar', 'Alquiler'],
        for: ['Distribuidores', 'Resorts'],
        specs: '5,80 m de eslora · manga 2,38 m · tubo de 0,58 m · 8 plazas · 115 CV máx.',
        artwork: 'Collar de 58 cm · consola de mando · opción de solárium con cojín',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-580b-01.avif',
        hue: 184,
      },
      {
        ...
        sku: 'NRB-580C',
        name: 'RIB 580C',
        tagline: 'Configuración retail a consola',
        desc: 'Un RIB de fibra de vidrio de 5,8 m con consola de parabrisas de serie — 115 CV, collar de 58 cm, depósito de 90 L y cinco cámaras. La configuración de mando cotidiano para líneas de retail.',
        uses: ['Líneas retail', 'Crucero de día', 'Alquiler'],
        for: ['Redes de distribuidor', 'Compradores retail'],
        specs: '5,80 m de eslora · manga 2,38 m · tubo de 0,58 m · 8 plazas · 115 CV máx.',
        artwork: 'Consola con parabrisas · asas y barra de esquí de acero inoxidable · targa con luces',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-580c-01.avif',
        hue: 186,
      },
      {
        ...
        sku: 'NRB-550A',
        name: 'RIB 550A',
        tagline: 'Bancos ligeros',
        desc: 'Un RIB de fibra de vidrio ligero de 5,5 m — 240 kg en seco, 90 CV y distribución abierta con bancos y depósito de 60 L. Fácil de remolcar sin renunciar a espacio familiar de verdad.',
        uses: ['Familiar', 'Fácil remolque', 'Costero'],
        for: ['Distribuidores', 'Gamas privadas'],
        specs: '5,50 m de eslora · manga 2,30 m · tubo de 0,52 m · 7 plazas · 90 CV máx.',
        artwork: '2 bancos · depósito de 60 L · opciones de consola y dirección',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-550a-01.avif',
        hue: 184,
      },
      {
        ...
        sku: 'NRB-550B',
        name: 'RIB 550B',
        tagline: 'El 5,5 m equipado',
        desc: 'Un RIB de fibra de vidrio de 5,5 m que añade consola, solárium de popa, asientos de proa y popa, arco de protección y un depósito de 100 L — 90 CV y collar de 5 cámaras. El 550 vestido para líneas retail y de alquiler.',
        uses: ['Crucero de día', 'Alquiler', 'Retail'],
        for: ['Operadores de alquiler', 'Distribuidores'],
        specs: '5,50 m de eslora · manga 2,30 m · tubo de 0,52 m · 7 plazas · 90 CV máx.',
        artwork: 'Solárium · arco de protección · respaldo y opciones de escalerilla de acero inoxidable',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-550b-01.avif',
        hue: 182,
      },
      {
        ...
        sku: 'NRB-520A',
        name: 'RIB 520A',
        tagline: 'El 5,2 m ligero',
        desc: 'Un RIB de fibra de vidrio estrecho y ligero de 5,2 m — 200 kg en seco, 85 CV y una distribución limpia con dos asientos y depósito de 60 L. Una plataforma de remolcar y listo para distribuidores y compradores privados.',
        uses: ['Familiar', 'Fácil remolque', 'Costero'],
        for: ['Distribuidores', 'Compradores privados'],
        specs: '5,20 m de eslora · manga 2,00 m · tubo de 0,52 m · 8 plazas · 85 CV máx.',
        artwork: '2 asientos · depósito de 60 L · opciones de consola y dirección',
        hue: 186,
      },
      {
        slug: 'rib-520b',
        ...
        sku: 'NRB-520B',
        name: 'RIB 520B',
        tagline: 'Familiar equilibrado a consola',
        desc: 'Un RIB de fibra de vidrio de 5,2 m con consola central, bancos delantero y trasero, depósito de 80 L y 85 CV — la especificación familiar equilibrada con la que la mayoría de gamas de distribuidor abren.',
        uses: ['Familiar', 'Líneas de distribuidor', 'Crucero de día'],
        for: ['Distribuidores', 'Charters emergentes'],
        specs: '5,20 m de eslora · manga 2,28 m · tubo de 0,52 m · 8 plazas · 85 CV máx.',
        artwork: 'Consola central · asientos completos · targa con luces de navegación',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-520b-01.avif',
        hue: 186,
      },
      {
        ...
        sku: 'NRB-520C',
        name: 'RIB 520C',
        tagline: 'Configuración con solárium',
        desc: 'Un RIB de fibra de vidrio de 5,2 m que añade solárium acolchado y herrajes de acero inoxidable a la distribución a consola — 360 kg en seco, 85 CV y opciones de depósito de 70 L.',
        uses: ['Crucero de día', 'Deportes náuticos', 'Retail'],
        for: ['Distribuidores', 'Resorts'],
        specs: '5,20 m de eslora · manga 2,28 m · tubo de 0,52 m · 8 plazas · 85 CV máx.',
        artwork: 'Cojín de solárium · asas de acero inoxidable · consola de mando',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-520c-01.avif',
        hue: 188,
      },
      {
        ...
        sku: 'NRB-520E',
        name: 'RIB 520E',
        tagline: 'Especificación sport de 115 CV',
        desc: 'Un RIB de fibra de vidrio de 5,2 m homologado a 115 CV — arco de acero inoxidable, respaldo con ojo de esquí, depósito con indicador de 80 L y consola desmontable. El 520 enérgico para deportes náuticos y salidas costeras más rápidas.',
        uses: ['Deportes náuticos', 'Velocidad', 'Alquiler premium'],
        for: ['Marcas lifestyle', 'Operadores de alquiler'],
        specs: '5,20 m de eslora · manga 2,25 m · tubo de 0,50 m · 8 plazas · 115 CV máx.',
        artwork: 'Arco y ojo de esquí de acero inoxidable · depósito con indicador · consola de mando · opción de solárium',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-520e-01.avif',
        hue: 180,
      },
      {
        ...
        sku: 'NRB-520W',
        name: 'RIB 520W',
        tagline: 'Amplio y ligero',
        desc: 'Un RIB de fibra de vidrio de manga amplia (2,35 m) con solo 230 kg — 85 CV, dos asientos y banco de proa en un cockpit estable y espacioso. Máxima sensación de cubierta con peso de remolque reducido.',
        uses: ['Familiar', 'Fácil remolque', 'Estabilidad'],
        for: ['Compradores privados', 'Distribuidores'],
        specs: '5,20 m de eslora · manga 2,35 m · tubo de 0,52 m · 8 plazas · 85 CV máx.',
        artwork: 'Manga de 2,35 m · 2 asientos · banco de proa · opciones de consola',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-520w-01.avif',
        hue: 184,
      },
      {
        ...
        sku: 'NRB-500',
        name: 'RIB 500',
        tagline: 'Consola equilibrada de 5 m',
        desc: 'Un RIB de fibra de vidrio de 5 m con consola de mando, bancos de proa y popa, depósito de 60 L y 60 CV — una plataforma equilibrada para distribuidores, resorts y flotas primerizas.',
        uses: ['Familiar', 'Alquiler', 'Líneas de distribuidor'],
        for: ['Distribuidores', 'Resorts'],
        specs: '5,00 m de eslora · manga 2,10 m · tubo de 0,52 m · 6 plazas · 60 CV máx.',
        artwork: 'Consola de mando · bancos completos · targa con luces de navegación',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-500-01.avif',
        hue: 188,
      },
      {
        ...
        sku: 'NRB-480A',
        name: 'RIB 480A',
        tagline: 'El 4,8 m ligero',
        desc: 'Un RIB de fibra de vidrio estilizado de 4,8 m con solo 183 kg — 60 CV, distribución de dos asientos y banco de proa. Lo bastante ligero para remolque de un eje con la estabilidad real de un RIB.',
        uses: ['Fácil remolque', 'Familiar', 'Costero'],
        for: ['Compradores privados', 'Distribuidores'],
        specs: '4,80 m de eslora · manga 2,00 m · tubo de 0,48 m · 6 plazas · 60 CV máx.',
        artwork: '2 asientos · banco de proa · espejo para 60 CV',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-480a-01.avif',
        hue: 190,
      },
      {
        ...
        sku: 'NRB-480B',
        name: 'RIB 480B',
        tagline: '4,8 m de trabajo a consola',
        desc: 'Un RIB de fibra de vidrio de 4,8 m con consola central, bancos de proa y popa y depósito de 60 L — 60 CV y cinco cámaras. La distribución práctica para alquiler y familia.',
        uses: ['Familiar', 'Alquiler', 'Utilidad'],
        for: ['Operadores de alquiler', 'Distribuidores'],
        specs: '4,80 m de eslora · manga 2,00 m · tubo de 0,48 m · 6 plazas · 60 CV máx.',
        artwork: 'Consola central · bancos completos · targa con luces de navegación',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-480b-01.avif',
        hue: 192,
      },
      {
        ...
        sku: 'NRB-480C',
        name: 'RIB 480C',
        tagline: '4,8 m con parabrisas',
        desc: 'Un RIB de fibra de vidrio de 4,8 m con consola de parabrisas e interruptor de 4 puntos de serie — 60 CV, cinco cámaras y asientos completos. Una especificación retail pulida para pasear de día.',
        uses: ['Paseo de día', 'Retail', 'Familiar'],
        for: ['Redes de distribuidor', 'Compradores retail'],
        specs: '4,80 m de eslora · manga 2,00 m · tubo de 0,48 m · 6 plazas · 60 CV máx.',
        artwork: 'Consola con parabrisas · asientos completos · opción de depósito de 60 L',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-480c-01.avif',
        hue: 194,
      },
      {
        ...
        sku: 'NRB-480D',
        name: 'RIB 480D',
        tagline: '4,8 m con escalerilla y solárium',
        desc: 'Un RIB de fibra de vidrio de 4,8 m que añade escalerilla de popa de acero inoxidable y solárium con cojín a la distribución a consola — 60 CV, cinco cámaras y un equipo de serie muy completo.',
        uses: ['Bañistas', 'Paseo de día', 'Familiar'],
        for: ['Resorts', 'Distribuidores'],
        specs: '4,80 m de eslora · manga 2,00 m · tubo de 0,48 m · 6 plazas · 60 CV máx.',
        artwork: 'Escalerilla de popa de acero inoxidable · solárium con cojín · consola de mando',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-480d-01.avif',
        hue: 192,
      },
      {
        ...
        sku: 'NRB-480W',
        name: 'RIB 480W',
        tagline: '4,8 m amplio para excursiones',
        desc: 'Un RIB de fibra de vidrio de manga amplia (2,35 m) con consola central y asiento lateral — 60 CV, depósito de 60 L y cinco cámaras en un cockpit espacioso para excursiones y paseos de día.',
        uses: ['Excursiones', 'Paseo de día', 'Familiar'],
        for: ['Operadores de excursiones', 'Resorts'],
        specs: '4,80 m de eslora · manga 2,35 m · tubo de 0,48 m · 6 plazas · 60 CV máx.',
        artwork: 'Consola con asiento lateral · depósito de 60 L · targa con luces',
        hue: 194,
      },
      {
        slug: 'rib-430a',
        ...
        sku: 'NRB-430A',
        name: 'RIB 430A',
        tagline: '4,3 m de entrada',
        desc: 'Un RIB de fibra de vidrio ligero de 4,3 m — 170 kg en seco, 40 CV y una distribución limpia con dos asientos. El acceso asequible a la línea 430 a consola.',
        uses: ['RIB de entrada', 'Familiar', 'Fácil remolque'],
        for: ['Nuevas marcas', 'Compradores privados'],
        specs: '4,30 m de eslora · manga 2,00 m · tubo de 0,47 m · 6 plazas · 40 CV máx.',
        artwork: '2 asientos · banco de proa · opciones de consola y dirección',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-430a-01.avif',
        hue: 196,
      },
      {
        ...
        sku: 'NRB-430B',
        name: 'RIB 430B',
        tagline: '4,3 m para lago',
        desc: 'Un RIB de fibra de vidrio de 4,3 m con consola central, ojos de remolque de esquí de acero inoxidable, preparación de depósito y collar de 4 cámaras — 40 CV orientado al deporte en lago y touring compacto.',
        uses: ['Deportes náuticos', 'Lago', 'Paseo de día'],
        for: ['Marcas lifestyle', 'Resorts'],
        specs: '4,30 m de eslora · manga 2,00 m · tubo de 0,47 m · 6 plazas · 40 CV máx.',
        artwork: 'Consola de mando · ojos de esquí de acero inoxidable · opción de depósito de 50 L',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-430b-01.avif',
        hue: 198,
      },
      {
        ...
        sku: 'NRB-430C',
        name: 'RIB 430C',
        tagline: '4,3 m muy opcional',
        desc: 'Un RIB de fibra de vidrio de 4,3 m con consola de parabrisas, arco de protección, depósito de combustible y una de las listas de opciones más largas de la gama — desde teca hasta dirección hidráulica.',
        uses: ['Paseo de día', 'Retail', 'Alquiler'],
        for: ['Distribuidores', 'Operadores de alquiler'],
        specs: '4,30 m de eslora · manga 1,96 m · tubo de 0,48 m · 6 plazas · 40 CV máx.',
        artwork: 'Arco de protección · consola con parabrisas · depósito de 50 L',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-430c-01.avif',
        hue: 196,
      },
      {
        ...
        sku: 'NRB-390A',
        name: 'RIB 390A',
        tagline: 'El 3,9 m ligero',
        desc: 'Un RIB de fibra de vidrio de 3,9 m con solo 100 kg — 30 CV, dos asientos y collar de 3 cámaras. Un auxiliar que se remolca detrás de cualquier coche y conserva la marcha de un casco moldeado.',
        uses: ['Auxiliar', 'Fácil remolque', 'Entrada'],
        for: ['Compradores privados', 'Nuevas marcas'],
        specs: '3,90 m de eslora · manga 1,85 m · tubo de 0,47 m · 5 plazas · 30 CV máx.',
        artwork: '2 asientos · banco de proa · opciones de consola y dirección',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-390a-01.avif',
        hue: 199,
      },
      {
        ...
        sku: 'NRB-390AL',
        name: 'RIB 390AL',
        tagline: '3,9 m a consola',
        desc: 'Un RIB de fibra de vidrio de 3,9 m con consola central de serie — 30 CV, collar de 4 cámaras, asientos delanteros acolchados y una lista completa de opciones que incluye solárium.',
        uses: ['Paseo de día', 'Familiar', 'Costero'],
        for: ['Distribuidores', 'Resorts'],
        specs: '3,90 m de eslora · manga 1,85 m · tubo de 0,42 m · 5 plazas · 30 CV máx.',
        artwork: 'Consola de mando · 4 cámaras · opción de solárium',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-390al-01.avif',
        hue: 201,
      },
      {
        ...
        sku: 'NRB-390B',
        name: 'RIB 390B',
        tagline: 'Consola compacta de 3,9 m',
        desc: 'Un RIB de fibra de vidrio de 3,9 m con consola central, bancos de proa y popa y bomba de achique — 30 CV, 3 cámaras y opciones de depósito de 40 L. La consola compacta práctica.',
        uses: ['Paseo de día', 'Excursiones', 'Familiar'],
        for: ['Resorts', 'Distribuidores'],
        specs: '3,90 m de eslora · manga 1,85 m · tubo de 0,47 m · 5 plazas · 30 CV máx.',
        artwork: 'Consola de mando · bancos completos · opción de depósito de 40 L',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-390b-01.avif',
        hue: 203,
      },
      {
        ...
        sku: 'NRB-390BL',
        name: 'RIB 390BL',
        tagline: 'El 3,9 m mejor equipado',
        desc: 'Un RIB de fibra de vidrio de 3,9 m con consola de parabrisas, arco de protección, solárium, depósito de 25 L y la lista de equipo de serie más completa de la línea 390 — 30 CV, 4 cámaras.',
        uses: ['Paseo de día', 'Retail', 'Alquiler'],
        for: ['Redes de distribuidor', 'Operadores de alquiler'],
        specs: '3,90 m de eslora · manga 1,78 m · tubo de 0,42 m · 5 plazas · 30 CV máx.',
        artwork: 'Consola con parabrisas · arco de protección · solárium · depósito de 25 L',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-390bl-01.avif',
        hue: 201,
      },
      {
        ...
        sku: 'NRB-360A',
        name: 'RIB 360A',
        tagline: 'Barco de día compacto',
        desc: 'Un RIB de fibra de vidrio de 3,6 m — 25 CV, tres cámaras y 650 kg de carga útil, con dos asientos y banco de proa. Un barco de día compacto que se remolca fácil.',
        uses: ['Paseo de día', 'Auxiliar', 'Familiar'],
        for: ['Compradores privados', 'Resorts'],
        specs: '3,60 m de eslora · manga 1,80 m · tubo de 0,42 m · 5 plazas · 25 CV máx.',
        artwork: '2 asientos · banco de proa · variantes de consola',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-360a-01.avif',
        hue: 205,
      },
      {
        ...
        sku: 'NRB-360B',
        name: 'RIB 360B',
        tagline: 'Compacto con asiento lateral',
        desc: 'Un RIB de fibra de vidrio de 3,6 m con consola central y asiento lateral, herrajes de acero inoxidable y bomba de achique — 25 CV y 100 kg en seco. Ideal para ciudad y lago.',
        uses: ['Paseo de día', 'Lago', 'Familiar'],
        for: ['Resorts', 'Compradores privados'],
        specs: '3,60 m de eslora · manga 1,80 m · tubo de 0,42 m · 5 plazas · 25 CV máx.',
        artwork: 'Consola con asiento lateral · asas de acero inoxidable · bomba de achique',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-360b-01.avif',
        hue: 207,
      },
      {
        ...
        sku: 'NRB-330A',
        name: 'RIB 330A',
        tagline: 'La entrada de 80 kg',
        desc: 'Un RIB de fibra de vidrio de 3,3 m con solo 80 kg — 20 CV y una distribución limpia de dos asientos. El RIB real más ligero de la gama, fácil de levantar y remolcar.',
        uses: ['Entrada', 'Auxiliar', 'Fácil remolque'],
        for: ['Compradores privados', 'Nuevas marcas'],
        specs: '3,30 m de eslora · manga 1,60 m · tubo de 0,42 m · 4 plazas · 20 CV máx.',
        artwork: 'Distribución mínima · opciones de consola y dirección',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-330a-01.avif',
        hue: 208,
      },
      {
        ...
        sku: 'NRB-330B',
        name: 'RIB 330B',
        tagline: '3,3 m con banco',
        desc: 'Un RIB de fibra de vidrio de 3,3 m con banco de proa y bandeja de ancla añadidos a la base de dos asientos — 20 CV, tres cámaras y 90 kg en seco.',
        uses: ['Paseo de día', 'Auxiliar', 'Familiar'],
        for: ['Resorts', 'Compradores privados'],
        specs: '3,30 m de eslora · manga 1,60 m · tubo de 0,42 m · 4 plazas · 20 CV máx.',
        artwork: 'Banco de proa · bandeja de ancla · opciones de consola y dirección',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-330b-01.avif',
        hue: 210,
      },
      {
        ...
        sku: 'NRB-330C',
        name: 'RIB 330C',
        tagline: 'Plataforma pequeña acabada',
        desc: 'Un RIB de fibra de vidrio de 3,3 m con consola central, asientos de proa y popa, opción de suelo de teca y 20 CV — la especificación de plataforma pequeña acabada para retail.',
        uses: ['Paseo de día', 'Retail', 'Alquiler'],
        for: ['Distribuidores', 'Operadores de alquiler'],
        specs: '3,30 m de eslora · manga 1,60 m · tubo de 0,42 m · 4 plazas · 20 CV máx.',
        artwork: 'Consola de mando · asientos completos · opción de teca',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-330c-01.avif',
        hue: 210,
      },
      {
        ...
        sku: 'NRB-300',
        name: 'RIB 300',
        tagline: 'Auxiliar compacto de 3 m',
        desc: 'Un RIB de 3 m de 90 kg homologado para 20 CV — capacidad para cuatro personas, huella compacta y una larga lista de complementos, desde ruedas hasta asientos.',
        uses: ['Auxiliar', 'Playa', 'Entrada'],
        for: ['Compradores privados', 'Resorts'],
        specs: '3,00 m de eslora · manga 1,60 m · tubo de 0,42 m · 4 plazas · 20 CV máx.',
        artwork: 'Huella compacta · opción de ruedas de botadura',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-300-01.avif',
        hue: 212,
      },
      {
        ...
        sku: 'NRB-270',
        name: 'RIB 270',
        tagline: 'Lancha ligera de 2,7 m',
        desc: 'Un RIB de 2,7 m de 64 kg homologado para 10 CV — capacidad para tres personas en un auxiliar ligero de fondo rígido que se guarda fácil y se bota en cualquier lugar.',
        uses: ['Auxiliar', 'Playa', 'Reserva'],
        for: ['Compradores privados', 'Yates'],
        specs: '2,70 m de eslora · manga 1,62 m · tubo de 0,42 m · 3 plazas · 10 CV máx.',
        artwork: '64 kg · 3 cámaras · fondo rígido',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-270-01.avif',
        hue: 213,
      },
      {
        ...
        sku: 'NRB-250',
        name: 'RIB 250',
        tagline: 'El auxiliar más portátil',
        desc: 'Un RIB de 2,5 m con solo 60 kg homologado para 4,4 CV — capacidad para tres personas, la huella más pequeña de la gama y el auxiliar de fibra más portátil.',
        uses: ['Auxiliar', 'Playa', 'Almacenaje'],
        for: ['Compradores privados', 'Yates'],
        specs: '2,50 m de eslora · manga 1,45 m · tubo de 0,38 m · 3 plazas · 4 CV máx.',
        artwork: '60 kg · huella compacta · 3 cámaras',
        image: 'https://neptunor.com/assets/products/2026/fiberglass-rib/rib-250-01.avif',
        hue: 214,
      },
      {
      ...
      },
      {
        ...
        specs: '3,30 m eslora · 1,55 m manga · 0,43 m tubo · 4+1 personas · 15 CV máx.',
...
const SUPPORTED_PRODUCT_SERIES = new Set(['aluminum-rib', 'fiberglass-rib', 'sport-console', 'rescue-pro', 'inflatable-dinghy'])

/** Public product feeds contain only Neptunor's RIB and inflatable-boat lines. */
export const products: Localized<ProductsContent> = {
  en: { ...allProducts.en, items: allProducts.en.items.filter((p) => SUPPORTED_PRODUCT_SERIES.has(p.series)) },
  es: { ...allProducts.es, items: allProducts.es.items.filter((p) => SUPPORTED_PRODUCT_SERIES.has(p.series)) },
}
/* ─────────────────────────── video showcases ─────────────────────────── */
...
export const boardCategories: Localized<BoardCategoriesContent> = {
  ...
  es: {
    kicker: 'Nuestros barcos',
    title: 'De botes inflables a RIB profesionales',
    ...
    projects: [
      {
        ...
        hue: 195,
        image: 'https://assets.neptunor.com/site/images/boats/quality/neptunor-batch-release-handover.webp',
      },
      {
        tag: 'Rescue Fleet',
        ...
        hue: 28,
        image: 'https://assets.neptunor.com/site/images/boats/fleet/neptunor-rescue-fleet-delivery.webp',
      },
      {
        ...
        hue: 210,
        image: 'https://assets.neptunor.com/site/images/boats/factory/neptunor-dealer-line-production.webp',
      },
    ],
  },
  es: {
...
export const homeFaq: Localized<FaqContent> = {
  en: {
    kicker: 'B2B Buyer FAQ',
    title: 'Questions Before You Request a Quote',
    sub: 'Short answers on manufacturing scope, MOQ, compliance, quality control and the next step.',
    items: [
      faq.en.items[1],
      faq.en.items[2],
      faq.en.items[5],
  ...
  es: {
    kicker: 'Preguntas de compradores B2B',
    title: 'Preguntas antes de solicitar un presupuesto',
    sub: 'Respuestas breves sobre alcance de fabricación, MOQ, cumplimiento, control de calidad y el siguiente paso.',
    items: [
      faq.es.items[1],
      faq.es.items[2],
      faq.es.items[5],
...
export const catalogDownload: Localized<CatalogContent> = {
  en: {
    kicker: 'B2B Product Catalog',
    title: 'Get the RIB & inflatable boat catalog and MOQ sheet',
    body: 'The five supported boat series — from compact inflatable dinghies to patrol-ready RIBs — with specifications, MOQ tiers, sample timing and packaging, sent to your inbox by our sales team within one business day.',
  ...
  es: {
    kicker: 'Catálogo B2B de embarcaciones',
    title: 'Recibe el catálogo de RIB e inflables y la ficha de MOQ',
    body: 'Las cinco series de embarcaciones — desde las neumáticas compactas hasta los RIB preparados para patrulla — con especificaciones, tramos de MOQ, tiempos de muestreo y embalaje, enviadas a tu correo por nuestro equipo comercial en un día laborable.',
...
export const series: Localized<SeriesContent> = {
  en: {
    ...
    title: 'Five Boat Platforms, One Factory',
    sub: 'From compact inflatable tenders to 7.6 m offshore RIB hulls — every series is a manufacturing platform ready for your private label.',
    items: [
      {
        title: 'Aluminum Hull RIBs',
        sku: 'NRB-A360',
  ...
  es: {
    ...
    title: 'Cinco plataformas náuticas, una fábrica',
    sub: 'De auxiliares inflables compactas a cascos RIB offshore de 7,6 m — cada serie es una plataforma de fabricación lista para tu marca privada.',
    items: [
      {
        title: 'RIB de aluminio',
        sku: 'NRB-A360',
