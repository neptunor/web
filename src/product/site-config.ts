...
export const HERO_CONTENT = {
  en: {
    ...
    titlePost: '',
    sub: 'OEM, ODM and private-label RIB boats and inflatable boats — from specification review and sample development to quality-controlled batch production in Qingdao, China.',
  ...
  es: {
    ...
    titlePost: '',
    sub: 'Botes RIB e inflables OEM, ODM y de marca privada — desde la revisión de especificaciones y desarrollo de muestras hasta la producción en serie con control de calidad en Qingdao, China.',
    ctaPrimary: 'Inicia tu proyecto de botes',
