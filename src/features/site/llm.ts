...
export function llmsSiteFull(): string {
  const DEEP_PAGES = new Set([
    '/factory', '/quality', '/oem-moq-guide', '/oem-boat-moq',
    '/inflatable-boat-certification', '/oem-trust-assurance',
    ...
    '/odm-development', '/oem-manufacturing', '/product-development',
    '/new-brand-trial-order', '/b2b-solutions-matrix',
    '/start-boat-project', '/oem-onboarding-guide',
    '/factory-audit-checklist', '/about/identity', ABOUT_BRAND_PATH,
    '/partners', '/news', '/technology',
    ...
    '/research/ce-certification-guide', '/research/oem-buyer-guide',
  ])
...
export function llmsSiteSpanishFull(): string {
