...
function indexNews(locale?: Locale): SiteIndexNews[] {
...
function indexProducts(locale?: Locale): SiteIndexProduct[] {
...
function indexTopics(locale?: Locale): SiteIndexTopic[] {
...
function indexCases(locale: Locale): SiteIndexCase[] {
...
function indexFor(page?: ContentPage, locale?: Locale): SiteIndexData {
