...
export const PUBLIC_PATHS: PublicPathEntry[] = [
  ...
  { path: '/solutions/private-label-boats', lastmod: '2026-06-01' },
  { path: '/solutions/fleet-rental', lastmod: '2026-06-01' },
  { path: '/solutions/rescue-professional', lastmod: '2026-06-01' },
  { path: '/solutions/yacht-tender-dealers', lastmod: '2026-06-01' },
  { path: '/projects', lastmod: '2026-08-15' },
  { path: '/knowledge', lastmod: '2026-06-25' },
  { path: '/oem-moq-guide', lastmod: '2026-08-20' },
  { path: '/oem-boat-moq', lastmod: '2026-08-20' },
  { path: '/inflatable-boat-certification', lastmod: '2026-08-20' },
  ...
  { path: '/start-boat-project', lastmod: '2026-08-20' },
